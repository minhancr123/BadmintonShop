                                    ...
                                    <div class="stat-card p-3 bg-light rounded">
                                        <div class="stat-number text-success fw-bold fs-4">
                                            <?php if($category->products && $category->products->where('is_active', true)->where('quantity', '>', 0)->count() > 0): ?>
                                                <?php echo e($category->products->where('is_active', true)->where('quantity', '>', 0)->count()); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\badminton-shop\resources\views/categories/index.blade.php ENDPATH**/ ?>