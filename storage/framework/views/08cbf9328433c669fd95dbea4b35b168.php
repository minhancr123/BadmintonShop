...
<?php $__env->startSection('title', 'Danh mục sản phẩm - Badminton Shop'); ?>
...
<div class="container">
                ...
                <div class="card category-card h-100 border-0 shadow-sm overflow-hidden">
                    ...
                    <div class="card-header-gradient text-center py-4 position-relative" 
                        <?php if($category->image): ?> 
                            style="background-image: url('<?php echo e(asset('storage/' . $category->image)); ?>'); background-size: cover; background-position: center; min-height: 200px;" 
                        <?php endif; ?>>
                        ...
                        <?php if($category->image): ?>
                            ...
                            <div class="position-relative z-1 h-100 d-flex flex-column justify-content-center align-items-center" style="min-height: 150px;">
                                <h4 class="card-title mb-0 text-white fw-bold" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.6); font-size: 1.5rem;"><?php echo e($category->name); ?></h4>
                            </div>
                        <?php else: ?>
                            <!-- Category Icon -->
                            <div class="category-icon mb-3">
                                ...
                                ?>
                                <div class="icon-circle <?php echo e($bgGradient); ?> mx-auto d-flex align-items-center justify-content-center">
                                    <i class="<?php echo e($iconClass); ?> <?php echo e($iconColor); ?>" style="font-size: 2.5rem;"></i>
                                </div>
                            </div>

                            <!-- Category Title -->
                            <h4 class="card-title mb-0 text-white fw-bold"><?php echo e($category->name); ?></h4>
                        <?php endif; ?>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body p-4">
                        <p class="card-text text-muted mb-4"><?php echo e($category->description ?: 'Khám phá các sản phẩm chất lượng trong danh mục này'); ?></p>
                            ...
                            <div class="row text-center g-3">
                                <div class="col-6">
                                    <div class="stat-card p-3 bg-light rounded">
                                        <div class="stat-number text-primary fw-bold fs-4"><?php echo e($category->products_count ?? 0); ?></div>
                                ...
                                <div class="col-6">
                                    <div class="stat-card p-3 bg-light rounded">
                                        <div class="stat-number text-success fw-bold fs-4">
                                            <?php if($category->products && $category->products->where('is_active', true)->where('quantity', '>', 0)->count() > 0): ?>
                                                <?php echo e($category->products->where('is_active', true)->where('quantity', '>', 0)->sum('quantity')); ?>
                            ...
                            <div class="price-range mb-4 p-3 bg-gradient-light rounded">
                                <div class="text-center">
                                    ...
                                    <div class="price-text">
                                        <span class="fw-bold text-dark"><?php echo e(number_format($minPrice)); ?>₫</span>
                                        <span class="text-muted mx-2">-</span>
                                        <span class="fw-bold text-dark"><?php echo e(number_format($maxPrice)); ?>₫</span>
                                    </div>
                                </div>
                            </div>
                            <?php endif; ?>
                        ...
                        <div class="d-grid mt-auto">
                            <a href="<?php echo e(route('categories.show', $category->slug)); ?>" class="btn btn-primary btn-lg">
    ...
    <?php if($popularCategories && $popularCategories->count() > 0): ?>
    <div class="row mt-5">
        <div class="col-12">
            <hr class="my-5">
            <h3 class="text-center mb-4">Danh mục phổ biến</h3>
            <div class="row">
                <?php $__currentLoopData = $popularCategories->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popularCategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4 mb-4">
                    <div class="card bg-light border-0">
                        <div class="card-body text-center">
                            <i class="fas fa-star text-warning mb-2" style="font-size: 2rem;"></i>
                            <h5><?php echo e($popularCategory->name); ?></h5>
                            <p class="text-muted small"><?php echo e($popularCategory->products_count); ?> sản phẩm</p>
                            <a href="<?php echo e(route('categories.show', $popularCategory->slug)); ?>" class="btn btn-sm btn-warning">
                                Xem ngay
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="card product-card h-100 border-0 shadow-sm">
                        ...
                        <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : 'https://via.placeholder.com/300x200?text=No+Image'); ?>" 
                             class="card-img-top" alt="<?php echo e($product->name); ?>" style="height: 180px; object-fit: cover;">
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="mt-auto">
                                ...
                                <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="btn btn-outline-primary btn-sm w-100">
                                    Xem chi tiết
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Desktop\BadmintonShop\resources\views/categories/index.blade.php ENDPATH**/ ?>