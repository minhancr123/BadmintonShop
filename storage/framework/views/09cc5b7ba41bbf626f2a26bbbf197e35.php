                            ...
                            <div class="card-body">
                                ...
                                <div class="order-totals">
                                    ...
                                    <div class="alert alert-success d-flex justify-content-between align-items-center mb-3">
                                        <div>
                                            <strong>Mã giảm giá: <?php echo e($coupon['code']); ?></strong>
                                            <?php if(!empty($coupon['description'])): ?>
                                            <div class="small text-muted"><?php echo e($coupon['description']); ?></div>
                                            <?php endif; ?>
                                        </div>
                                        <?php if($discount > 0): ?>
                                        <span class="badge bg-success">-<?php echo e(number_format($discount)); ?>₫</span>
                                        <?php endif; ?>
                                    </div>
                                    <?php endif; ?>
                                    ...
                                    <small class="text-muted mb-2 d-block">
                                        <i class="fas fa-info-circle"></i> Mua thêm <?php echo e(number_format($remainingForFreeShipping)); ?>₫ để được miễn phí vận chuyển
                                    </small>
                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Desktop\BadmintonShop\resources\views/orders/checkout.blade.php ENDPATH**/ ?>