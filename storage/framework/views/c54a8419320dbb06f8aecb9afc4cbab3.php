                                    ...
                                    <div class="btn-group btn-group-sm" role="group">
                                        ...
                                        <?php if($product->is_active): ?>
                                            <button class="btn btn-outline-warning" 
                                                    onclick="toggleStatus(<?php echo e($product->id); ?>, 'deactivate')" 
                                                    title="Vô hiệu hóa">
                                                <i class="fas fa-pause"></i>
                                            </button>
                                        <?php else: ?>
                                            <button class="btn btn-outline-success" 
                                                    onclick="toggleStatus(<?php echo e($product->id); ?>, 'activate')" 
                                                    title="Kích hoạt">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Desktop\BadmintonShop\resources\views/admin/products/index.blade.php ENDPATH**/ ?>