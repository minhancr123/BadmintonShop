...
<?php $__env->startSection('title', 'Viết đánh giá - ' . $product->name); ?>
...
<div class="container py-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('products.show', $product->slug)); ?>"><?php echo e($product->name); ?></a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex mb-4">
                        <img src="<?php echo e($product->image ? Storage::url($product->image) : '/images/no-image.png'); ?>" 
                             alt="<?php echo e($product->name); ?>" class="me-3" style="width: 80px; height: 80px; object-fit: cover;">
                        <div>
                            <h5><?php echo e($product->name); ?></h5>
                            <p class="text-muted mb-0"><?php echo e($product->brand); ?></p>
                            <?php if($hasPurchased): ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="Chia sẻ chi tiết về trải nghiệm sử dụng sản phẩm..."><?php echo e(old('comment')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <div id="pros-container">
                                <?php if(old('pros')): ?>
                                    <?php $__currentLoopData = old('pros'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="input-group mb-2 pros-item">
                                            <input type="text" class="form-control" name="pros[]" value="<?php echo e($pro); ?>" 
                                                   placeholder="Ưu điểm <?php echo e($index + 1); ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <div id="cons-container">
                                <?php if(old('cons')): ?>
                                    <?php $__currentLoopData = old('cons'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $con): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="input-group mb-2 cons-item">
                                            <input type="text" class="form-control" name="cons[]" value="<?php echo e($con); ?>" 
                                                   placeholder="Nhược điểm <?php echo e($index + 1); ?>">
                                            <button type="button" class="btn btn-outline-danger remove-item">×</button>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="<?php echo e(route('products.show', $product->slug)); ?>" class="btn btn-secondary">Hủy</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Desktop\BadmintonShop\resources\views/reviews/create.blade.php ENDPATH**/ ?>