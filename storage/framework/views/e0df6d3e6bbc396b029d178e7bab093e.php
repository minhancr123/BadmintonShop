...
<?php $__env->startSection('title', 'Trang chủ - Badminton Shop'); ?>
            ...
            <div class="col-lg-6">
                <div class="hero-content">
                    ...
                    <div class="d-flex gap-3 mb-4">
                        <a href="<?php echo e(route('products.index')); ?>" class="btn btn-warning btn-lg px-5 py-3 fw-bold">
        ...
        <div class="row">
            <div class="col-md-3 col-6 mb-4">
                <div class="stat-card text-center">
                    ...
                    <h3 class="fw-bold text-primary mb-1"><?php echo e($stats['total_products']); ?>+</h3>
            ...
            <div class="col-md-3 col-6 mb-4">
                <div class="stat-card text-center">
                    ...
                    <h3 class="fw-bold text-success mb-1"><?php echo e($stats['total_categories']); ?>+</h3>
            ...
            <div class="col-md-3 col-6 mb-4">
                <div class="stat-card text-center">
                    ...
                    <h3 class="fw-bold text-warning mb-1"><?php echo e($stats['products_on_sale']); ?>+</h3>
...
<section id="featured" class="featured-section py-5">
    <div class="container">
            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="product-card h-100 border-0 shadow-sm position-relative overflow-hidden">
                    ...
                    <div class="sale-badge position-absolute top-0 end-0 bg-danger text-white px-3 py-1 rounded-start">
                        ...
                        Giảm <?php echo e($product->discount_percentage); ?>%
                    </div>
                    <?php endif; ?>
                    
                    <div class="product-image-wrapper position-relative overflow-hidden">
                        <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : 'https://images.unsplash.com/photo-1544919982-b61976f0ba43?w=400&h=300&fit=crop'); ?>" 
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        <h5 class="card-title fw-bold mb-3" style="height: 2.5em; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;"><?php echo e($product->name); ?></h5>
                        <p class="card-text text-muted small mb-3 flex-grow-1" style="height: 3em; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;"><?php echo e(Str::limit($product->description, 80)); ?></p>
                        <div class="price-wrapper mb-3">
                            <?php if($product->is_on_sale): ?>
                                <span class="current-price text-danger fw-bold fs-5">
                                    <?php echo e(number_format($product->sale_price, 0, ',', '.')); ?>đ
                                </span>
        ...
        <div class="text-center mt-4">
            <a href="<?php echo e(route('products.index')); ?>" class="btn btn-outline-primary btn-lg px-5">
...
<!-- Popular Categories -->
<?php if($popularCategories->count() > 0): ?>
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="category-card h-100 border-0 shadow-sm position-relative overflow-hidden bg-white rounded-3">
                    <div class="category-header p-4 text-center">
                        ...
                        <p class="text-muted mb-3"><?php echo e($category->products_count); ?> sản phẩm</p>
...
<section class="sale-section py-5 bg-gradient-primary text-white">
    <div class="container">
        ...
        <div class="row">
            <?php $__currentLoopData = $saleProducts->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="sale-product-card bg-white text-dark rounded-3 shadow-lg overflow-hidden h-100">
                    <div class="position-relative">
                        <img src="<?php echo e($product->image ? asset('storage/' . $product->image) : 'https://images.unsplash.com/photo-1544919982-b61976f0ba43?w=400&h=250&fit=crop'); ?>" 
                             class="card-img-top" 
                             alt="<?php echo e($product->name); ?>"
                    ...
                    <div class="card-body p-4 d-flex flex-column">
                        <h5 class="card-title fw-bold mb-2" style="height: 2.5em; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;"><?php echo e($product->name); ?></h5>
                        <div class="price-comparison mb-3 flex-grow-1">
                            ...
                            <small class="text-success fw-bold">
                                Tiết kiệm: <?php echo e(number_format($product->price - $product->sale_price, 0, ',', '.')); ?>đ
                            </small>
                        </div>
                        <div class="d-grid mt-auto">
                            <a href="<?php echo e(route('products.show', $product->slug)); ?>" 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\GIGABYTE\Desktop\BadmintonShop\resources\views/welcome.blade.php ENDPATH**/ ?>