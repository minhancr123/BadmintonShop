                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="shipping_name" class="form-label">Họ và tên người nhận <span class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>" 
                                                  ...
                                                  required placeholder="Nhập địa chỉ chi tiết (số nhà, đường, quận/huyện, tỉnh/thành)"><?php echo e(old('shipping_address', auth()->user()->address)); ?></textarea>
                                        ...
                                        <label class="form-check-label w-100" for="bank_transfer">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Chuyển khoản trước, giao hàng sau xác nhận</small>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                                    <!-- Future payment methods can be added here -->
                                    <div class="form-check payment-option mb-3 p-3 border rounded" style="opacity: 0.6;">
                                        ...
                                        <label class="form-check-label w-100">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <small class="text-muted">Thanh toán online bằng thẻ Visa, MasterCard</small>
                                                </div>
                                            </div>
                                        </label>
                                    </div>
                                ...
                                <div id="bankTransferDetails" class="alert alert-info" style="display: none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0"><small class="text-muted">Đơn hàng sẽ được xử lý sau khi chúng tôi nhận được thanh toán</small></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    phoneInput.addEventListener('input', function() {
        ...
        if (this.value && !isValid) {
            this.setCustomValidity('Vui lòng nhập số điện thoại hợp lệ (10-11 số, bắt đầu bằng 0 hoặc +84)');
        } else {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\BadmintonShop\resources\views/orders/checkout.blade.php ENDPATH**/ ?>