...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Trang quản trị'); ?> - <?php echo e(config('app.name')); ?></title>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 content-wrapper">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h1 class="h2 mb-0"><?php echo $__env->yieldContent('page-title', 'Trang quản trị'); ?></h1>
...
<?php /**PATH C:\Users\GIGABYTE\Desktop\BadmintonShop\resources\views/admin/layout.blade.php ENDPATH**/ ?>