                    ...
                    <?php else: ?>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo e(route('dashboard')); ?>">Bảng điều khiển</a></li>
                                <li><a class="dropdown-item" href="<?php echo e(route('orders.index')); ?>">Đơn hàng của tôi</a></li>
                                <?php if(Auth::user()->isAdmin()): ?>
                                    <li><hr class="dropdown-divider"></li>
                                    <li><a class="dropdown-item" href="<?php echo e(route('admin.dashboard')); ?>">Trang quản trị</a></li>
                                <?php endif; ?>
                                <li><hr class="dropdown-divider"></li>
                                <li>
...
<?php /**PATH C:\Users\GIGABYTE\Desktop\BadmintonShop\resources\views/layouts/app.blade.php ENDPATH**/ ?>