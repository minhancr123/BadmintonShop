            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="h3 mb-0 text-white"><?php echo e(number_format($reportData['sales_summary']['total_sales'])); ?>₫</div>
                        <small class="text-white-50">
                            Kỳ <?php echo e($period === '7days' ? '7 ngày' : ($period === '30days' ? '30 ngày' : ($period === '3months' ? '3 tháng' : '1 năm'))); ?> qua
                        </small>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col">
                        ...
                        <div class="h3 mb-0 text-white"><?php echo e(number_format($reportData['sales_summary']['total_orders'])); ?></div>
                            ...
                            <tbody>
                                <?php $__currentLoopData = $reportData['top_products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-light text-dark"><?php echo e($product->category->name ?? 'N/A'); ?></span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="fw-bold text-primary"><?php echo e(number_format($product->total_sold * $product->current_price)); ?>₫</span>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-md-6">
                        <div class="bg-light p-3 rounded">
                            ...
                            <div class="row text-center">
                                <div class="col-4">
                                    <div class="fw-bold text-primary"><?php echo e(number_format($reportData['sales_summary']['total_sales'])); ?>₫</div>
                                    <small class="text-muted">Doanh thu</small>
                                </div>
                                <div class="col-4">
                                    <div class="fw-bold text-success"><?php echo e($reportData['sales_summary']['total_orders']); ?></div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\BadmintonShop\resources\views/admin/reports.blade.php ENDPATH**/ ?>