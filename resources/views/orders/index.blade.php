...
@section('title', 'Đơn hàng của tôi - Badminton Shop')
                    ...
                    <div class="col-12 mb-4">
                        <div class="card order-card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <div>
                                    <h6 class="mb-0">
                                        <strong>Đơn hàng #{{ $order->order_number ?? $order->id }}</strong>
                            ...
                            <div class="card-body">
                                ...
                                <div class="order-items mb-3">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        <img src="{{ $item->product && $item->product->image ? asset('storage/' . $item->product->image) : 'https://via.placeholder.com/60x60?text=No+Image' }}" 
                                             class="rounded me-3" alt="{{ $item->product->name ?? 'Product' }}" style="width: 60px; height: 60px; object-fit: cover;">
                                    ...
                                    <div class="col-md-6">
                                        <div class="order-info">
                                            ...
                                            <p class="mb-1">
                                                ...
                                                @endphp
                                                <span class="badge bg-{{ $paymentStatusClass }} ms-1">{{ $paymentStatusText }}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-md-6 text-md-end">
                                        <div class="order-total mb-3">
                                            <h4 class="text-primary">{{ number_format($order->total_amount) }}₫</h4>
                                        </div>
                                        <div class="order-actions">
                                            ...
                                            @if($order->status == 'delivered')
                                                <button class="btn btn-success btn-sm me-2" onclick="reorderItems({{ $order->id }})">
                                            ...
                                            @if($order->status == 'delivered')
                                                <a href="{{ route('orders.invoice', $order) }}" class="btn btn-outline-secondary btn-sm" target="_blank">
