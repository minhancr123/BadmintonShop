...
@section('title', 'Chi tiết đơn hàng #' . ($order->order_number ?? $order->id) . ' - Badminton Shop')
        ...
        <div class="col-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="text-end">
                    ...
                    @endphp
                    <span class="badge bg-{{ $statusClass }} fs-6 mb-2">{{ $statusText }}</span><br>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="timeline">
                        ...
                        <div class="timeline-item {{ in_array($order->status, ['processing', 'shipped', 'delivered']) ? 'completed' : ($order->status == 'pending' ? 'active' : '') }}">
                            <div class="timeline-marker">
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <h5 class="mb-0">
                                ...
                                Sản phẩm ({{ $order->orderItems->count() }} món)
                            </h5>
                        </div>
                        <div class="card-body p-0">
                            @foreach($order->orderItems as $item)
                            <div class="order-item d-flex align-items-center p-3 {{ !$loop->last ? 'border-bottom' : '' }}">
                                <div class="item-image me-3">
                                    <img src="{{ $item->product && $item->product->image ? asset('storage/' . $item->product->image) : 'https://via.placeholder.com/80x80?text=No+Image' }}" 
                                         class="rounded" alt="{{ $item->product->name ?? 'Product' }}" 
                                ...
                                <div class="item-details flex-grow-1">
                                    ...
                                    @if($item->product)
                                        ...
                                        <small class="text-muted">Danh mục: {{ $item->product->category->name ?? 'N/A' }}</small>
                                    @endif
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <span class="text-capitalize">{{ $order->payment_method ?? 'COD' }}</span>
                                    @php
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <strong class="text-primary fs-4">{{ number_format($order->total_amount) }}₫</strong>
                            </div>
                        </div>
                    </div>
                </div>
